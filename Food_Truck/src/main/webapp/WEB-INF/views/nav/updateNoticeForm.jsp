...
<%@include file="../comm/nav.jsp" %>
	...
	<div class="featured-product section fix">
		<div class="container">
			...
			<form id="frm" action="/updateNotice?noticeNo=${notice.noticeNo}" method="post">
				<table class="table">
				<tr>
					<th>제목</th>
				...
				<tr>
					<th>내용</th>
					<td>
						<textarea name="noticeContent" id="editor" style="width: 610px ; height: 220px;" rows="10" cols="30"> ${notice.noticeContent} </textarea>
					</td>
				</tr>
				</table>

   ...
   $(function() {
      ...
      function totalPrice() {
         ...
         $(".sumPriceResult").html(function() {
            ...
            var discount = Number($("#discount option:selected").val())
            var dc = discount
               test = Number(test * dc * 0.01)
               return test;
         });
            ...
            <div class="col-sm-6 col-md-5">
               <div class="product">
                  ...
                  <div>
                     ...
                     <label style="<%=ftruckDlvYn.equals("N") ? "display: none;" : ""%>">
                     <input type="radio" name="ordDlyYn" value="Y" style="width: 50px;" id="dly"> 배달하기</label>
                  </div>
                  <br>

...
<script type="text/javascript">
	$(function() {
		...
		$("#signup-form").on("submit", function() {
			...
			if ($('input:radio[id=res]').is(':checked')) {
			...
			<div class="row2">
				...
				<div class="col-sm-6 col-md-5">
					<div class="product">
						<h2>Please order</h2>
						<div>
							<label><input type="radio" name="ordDlyYn" value="N" id="res" style="width: 50px; margin-left: 150px; float: left;">예약하기</label>
							<label style="<%=ftruckDlvYn.equals("N") ? "display: none;" : ""%>"><input type="radio" name="ordDlyYn" value="Y" style="width: 50px; margin-left: 150px;" id="dly">배달하기</label>
						</div>
						<br>
                     ...
                     <label>주소<span>*</span></label> <input type="text"
                        name="dlvAddr1" id="sample5_address" readonly
                        placeholder="주소검색을 클릭해주세요"><input type="text"
                        name="dlvAddr2" placeholder="나머지 주소를 입력해주세요"><input

		...
		<div class="row-fluid">
			<div class="span3" id="sidebar">
				<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
					...
					<li class="active"><a href="/sellerQnA?pageNo=1"><i
							...
							<div class="span12">
								<table cellpadding="0" cellspacing="0" border="0"
									...
									<thead align="center">
										<tr align="center">
											<th>사업자번호</th>
											<th width="100px" align="center">대분류</th>
										...
										<c:forEach items="${list}" var="all">
											<tr class="odd gradeX" align="center">
												...
												<td><a href="#myModal" data-toggle="modal"
													data-id="${all.qaScNo}" onclick="modal(this)">${all.qaScTitle}</a></td>
												<td>${all.memId }</td>
								...
								<div class="pagination" align="center">
									<ul>
										...
										<%
											...
											if (currentPage > 1) {
										%>
										<li><a href="memberQnA?pageNo=<%=currentPage - 1%>"><i
										...
										%>
										<li><a href="memberQnA?pageNo=<%=iCount%>"><%=iCount%></a>
										<li>
											<%
												}
												}

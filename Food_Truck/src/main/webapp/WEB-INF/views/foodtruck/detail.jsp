      ...
      <div class="row">
         ...
         <!-- Tab panes -->
               <div class="tab-content details-pro-tab-content">
                  <div class="tab-pane fade in active" id="image-1">
                     <div class="simpleLens-big-image-container">
                        <a class="simpleLens-lens-image" data-lens-image="/resources/img/foodtruck/<%=vo.getFtruckImg() %>">
               ...
               <ul class="tabs-list details-pro-tab-list" role="tablist">
                  <li class="active"><a href="#image-1" data-toggle="tab"><img src="/resources/img/foodtruck/<%=vo.getFtruckImg() %>" alt="" /></a></li>
                  <li><a href="#image-2" data-toggle="tab"><img src="/resources/img/foodtruck/<%=vo.getFtruckImg() %>" alt="" /></a></li>
                  <li><a href="#image-3" data-toggle="tab"><img src="/resources/img/foodtruck/<%=vo.getFtruckImg() %>" alt="" /></a></li>
                  <li><a href="#image-4" data-toggle="tab"><img src="/resources/img/foodtruck/<%=vo.getFtruckImg() %>" alt="" /></a></li>
               </ul>
            </div>
         </div>
         <div class="col-sm-6">
            <div class="shop-details">
               ...
               <h3>주소:<%=vo.getFtruckAddr() %></h3>
               <h4>평점</h4>
               <h5>전화번호:<%=vo.getFtruckTel() %></h5>
               
               
               <div class="review">
                  <div id="map" style="width: 550px; height: 370px;"></div>
                  <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=1594f377719d55bc26a9e84b3c7ec889"></script>
         ...
         <div class="col-sm-12 fix">
            <div class="description">
               ...
               <ul class="nav product-nav">
                  <li class="active"><a data-toggle="tab" href="#description">푸드트럭 소개</a></li>

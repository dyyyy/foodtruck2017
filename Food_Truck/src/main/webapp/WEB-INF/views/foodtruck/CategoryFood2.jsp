			...
			<div class="col-md-9">
				<div class="row">
					<div class="shop-tool-bar col-sm-12 fix">
						<div class="view-mode">
							<a href="/CategoryFood2?pageNo=1&category=${categoryno}'0'].category}" class="active"><i class="fa fa-th"></i></a>
							<a href="/CategoryFood?pageNo=1&category=${categoryno}"><i class="fa fa-th-list"></i></a>
						</div>
						<div class="sort-by">
							<span>Sort By</span>
							<select name="sort-by">

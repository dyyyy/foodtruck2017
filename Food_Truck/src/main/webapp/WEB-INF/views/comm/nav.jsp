					...
					<!-- 로그인 로직 -->
						...
						<%
							...
							<%
								...
								<li>
									<a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<img src='/resources/img/ms3.png'><i class="fa fa-angle-down"></i>
									</a>
									<ul>
							...
							<%
								...
								case "1":
							%>
									<li><a href="/stute?pageNo=1">관리자 메뉴</a></li>
							<%
								break;
								default:
							%>
		...
		<div class="row">
			...
			<div class="col-sm-4 col-lg-6">
				<div class="logo text-center">
					<a href="/"> <img src="/resources/img/header/logo.png" alt="" /></a>
				</div>
			</div>
			...
			<div class="col-sm-4 col-lg-3">
				<div class="search float-right">
					<div id="search1">
						<button onclick="getLocation()" id="getLocation" class="ico-loc"></button>
					</div>
					...
					<form action="/search" method="get">
						...
						<div id="search2">
							...
							<input type="text" id="search" name="search" placeholder="예) 강남구, 서초구" value="" />
						</div>
						<div id="search3">
							<button class="submit" id="locbtn"><i class="fa fa-search"></i></button>
						</div>
					</form>
				</div>
			</div>
			...
			<div class="clo-md-12">
				<div class="main-menu hidden-sm hidden-xs">
					<nav>
						<ul>
							<!-- 푸드트럭 리스트 -->
							<li><a href="/menuBoard?pageNo=1" class="active">FoodTruck List</a></li>
							<!-- 한식  -->
							<li><a href="/CategoryFood?pageNo=1&category=1">Korean Food</a></li>
							<!-- 중식  -->
							<li><a href="/CategoryFood?pageNo=1&category=2">Chinese Food</a></li>
							<!-- 양식  -->
							<li><a href="/CategoryFood?pageNo=1&category=3">Western Food</a></li>
							<!-- 일식  -->
							<li><a href="/CategoryFood?pageNo=1&category=4">Japanese Food</a></li>
						</ul>
					</nav>
				</div>
			</div>

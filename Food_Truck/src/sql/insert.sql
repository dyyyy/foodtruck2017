/*admin insert*/
insert into admin values('admin','admin','010-2644-5584');
insert into admin values('admin01','admin01','010-5561-8445');


/*seller insert*/
insert into seller values('seller','seller','손혜연','010-7566-5921');
insert into seller values('seller01','seller01','최재혁','010-1234-2165');
insert into seller values('seller02','seller02','김현각','010-1234-2165');

/*license_no insert*/
insert into license_no values('2208183676','seller');
insert into license_no values('1048636968','seller01');
insert into license_no values('5215685165','seller02');
insert into license_no values('2266165516','seller02');
insert into license_no values('6516523553','seller02');
insert into license_no values('6565165166','seller01');
insert into license_no values('1631165353','seller02');
insert into license_no values('5165133515','seller');
insert into license_no values('6545135555','seller');
insert into license_no values('6553633533','seller');

/*foodtruck insert*/
insert into foodtruck values('2208183676','또래오래','010-8559-4645','서울시 관악구','Y','N','Y',1.6,'img1.png','37.50179833140776','127.024631510072');
insert into foodtruck values('1048636968','BBQ','010-8559-5116','서울시 은평구','N','Y','Y',2.3,'img2.png','37.501483068205566','127.02420165745722');
insert into foodtruck values('5215685165','미스터피자','010-8559-4645','서울시 동대문구','Y','N','Y',2.4,'img3.png','37.50053696312773','127.02443884199365');
insert into foodtruck values('2266165516','파파존스','010-8559-5116','서울시 금천구','Y','N','Y',1.9,'img4.png','37.49870963045177','127.0269346568284');
insert into foodtruck values('6516523553','7번가피자','010-8559-4625','서울시 마포구','Y','N','Y',5.0,'img5.png',NULL,NULL);
insert into foodtruck values('1631165353','피자헛','010-8559-4645','서울시 영등포구','Y','N','Y',2.3,'img6.png',NULL,NULL);
insert into foodtruck values('5165133515','롯데리아','010-8559-4645','서울시 구로구','Y','N','Y',2.0,NULL,NULL,NULL);
insert into foodtruck values('6545135555','취홍','010-8559-5116','서울시 강남구','Y','N','Y',1.1,NULL,NULL,NULL);
insert into foodtruck values('6553633533','1인가득밥상','010-8559-4645',NULL,'N','N','N',0.0,NULL,NULL,NULL);
...
/*member insert*/
insert into member values('user','user','문성현','010-5498-6165');
insert into member values('user01','user01','문현성','010-4352-2346');

/*orders insert*/
insert into orders values(123456789112344,'문성현','010-5498-6165',SYSDATE,'2017/12/13','Y','user');

...
ALTER TABLE REVIEW
	DROP
		CONSTRAINT FK_FOODTRUCK_TO_REVIEW
		CASCADE;
...
/* 판매자 */
CREATE TABLE SELLER (
	SEL_ID VARCHAR2(150) NOT NULL, /* 판매자아이디 */
...
/* 회원 */
CREATE TABLE MEMBER (
	MEM_ID VARCHAR2(150) NOT NULL, /* 회원아이디 */
...
CREATE TABLE FOODTRUCK (
	...
	FTRUCK_GRADE NUMBER(3,1) DEFAULT 1.0 NOT NULL, /* 평점 */
	FTRUCK_IMG VARCHAR2(255), /* 푸드트럭이미지 */
	LATITUDE VARCHAR2(255), /* 위도 */
	LONGITUDE VARCHAR2(255), /* 경도 */
	CATEGORY NUMBER(2) DEFAULT 00 /* 카테고리 */
);
...
/* 관리자 */
CREATE TABLE ADMIN (
	ADMIN_ID VARCHAR2(150) NOT NULL, /* 관리자아이디 */
...
CREATE TABLE REVIEW (
	LICENSE_NO VARCHAR2(10) NOT NULL, /* 사업자번호 */
	REV_SEQ NUMBER DEFAULT 1 NOT NULL, /* 글번호 */
	REV_CONTENT VARCHAR2(255) NOT NULL, /* 내용 */
	REV_DTM DATE DEFAULT SYSDATE NOT NULL, /* 등록일 */
	REV_CNT NUMBER DEFAULT 0 NOT NULL, /* 조회수 */
	REV_DEL_YN CHAR(1) DEFAULT 'N' NOT NULL, /* 삭제여부 */
	GRADE NUMBER(3,1) DEFAULT 1.0 NOT NULL, /* 평점 */
	MEM_ID VARCHAR2(150) NOT NULL /* 회원아이디 */
);
